...
final class Store: ObservableObject {
    ...
    private let fileURL: URL = {
        ...
        return dir.appendingPathComponent("Border Stamp_entries.json")
    }()
    ...
    func seed() {
        entries = [
            Entry(country: "Sample A", crossingPoint: "Sample B", stayDays: 12, visitCount: 3, notes: "First sample entry"),
        ]
    }
