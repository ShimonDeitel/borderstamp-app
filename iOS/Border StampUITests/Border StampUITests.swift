...
final class BorderStampUITests: XCTestCase {
    ...
    func testAddEntryFlow() {
        ...
        let field1 = app.textFields["field_country"]
    ...
    func testFreeLimitTriggersPaywall() {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 2) || app.staticTexts["Border Stamp Pro"].waitForExistence(timeout: 2))
    }
